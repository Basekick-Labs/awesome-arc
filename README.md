...
- 🚀 **1.93M records/sec** ingestion via MessagePack
- 📊 **DuckDB query engine** for OLAP analytics
- 💾 **Parquet storage** on S3-compatible backends
- 🗄️ **Multi-database architecture** for data isolation
- ⚡ **Automatic compaction** for query optimization
- 🛡️ **Write-Ahead Log (WAL)** for zero data loss
...
### Data Ingestion
- **MessagePack Protocol**: 7.9× faster than Line Protocol (1.93M rec/s)
...
| Metric | Performance |
|--------|-------------|
| **Write Throughput** | 1.93M records/sec (MessagePack) |
...
### Write Optimization
1. **Use MessagePack**: 7.9× faster than Line Protocol
